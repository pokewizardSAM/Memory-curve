...
def fix_list_for_tabulate(unprocessed_list):
    print("unprocessed list: ",unprocessed_list)
    ...
    for i in range(0, n):
        ...
        print("processed list:",processed_lists)
...
def centre_table(table,table_type,showind, header= False):
    table_str = tabulate(table,headers=header,tablefmt=table_type,showindex=showind)
                ...
                while True:  # /Users/sameer/Desktop/PYTHON PROJECTS/PROXY MAKER /PROXYMAKER-V1.1.2.py
                    with open(f"{script_directory}/TIME TABLE 2023-24 - {day}.csv", "r+", newline="") as Teacher_db:
                        ...
                        if sub_user_choice == "1":
                            ...
                            centre_table(fix_list_for_tabulate(get_all_teachers(db_reader)),"fancy_grid")
